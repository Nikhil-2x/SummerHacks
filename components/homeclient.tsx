      ...
      >
        <div className="container mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base md:text-lg font-serif font-semibold tracking-tight text-foreground">
                LabLens
              </h1>
              <p className="text-[9px] md:text-[10px] text-muted-foreground font-medium tracking-wider uppercase">
                Health Insights
              </p>
            </div>
          </div>
              ...
              <div className="container mx-auto px-4 md:px-6 pt-12 md:pt-20 pb-8">
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="text-center mb-12 md:mb-16 relative">
                    ...
                    >
                      Upload your lab results and instantly understand what each
                      biomarker means. Get personalized insights to take control
                      of your health.
                    </motion.p>
                      ...
                      {[
                        {
                          ...
                          title: "Upload Report",
                          description:
                            "Drop your PDF or image of blood test results",
                          step: "01",
                        },
                        {
                          icon: Activity,
                          ...
                          description:
                            "AI extracts and interprets every biomarker",
                          step: "02",
                        },
                        {
                          icon: HeartPulse,
                  ...
                  >
                    <p className="text-sm text-muted-foreground/60 max-w-md mx-auto">
                      Your data is processed locally and never stored on our
                      servers. We respect your privacy completely.
                    </p>
                  </motion.div>
                </div>
              </div>
